...
About the Developer:
Pranav is a results-driven Data Analyst with over 3 years of experience engineering ETL pipelines and building scalable dashboards. He specializes in translating large-scale data into actionable insights using SQL, Python, Power BI, and Tableau. He is currently pursuing an MS in Business Analytics and AI at the University of Texas at Dallas (expected May 2026). This project serves as part of his ongoing research into healthcare financial metrics and regulatory data analysis.